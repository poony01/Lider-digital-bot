...
const OWNER_ID = Number(process.env.OWNER_ID); // Novo dono

// Botões visíveis no menu Telegram
bot.setMyCommands([
  ...
  // Comandos visíveis apenas para dono
  ...(OWNER_ID
    ? [
  ...
  try {
    ...
    if (update.message && update.message.text) {
      ...
      if (text.startsWith("/start")) {
        ...
        return await bot.sendMessage(chat.id, `👋 Olá, ${nome}! Seja bem-vindo(a).`, {
          parse_mode: "Markdown",
        });
      }
      ...
      // Comando: /zerarsaldo [somente dono]
